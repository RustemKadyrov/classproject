# Generated by Django 3.0 on 2022-02-09 15:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app1.Account', verbose_name='аккаунт')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app1.Group', verbose_name='группа')),
            ],
            options={
